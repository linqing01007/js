...
const handler4 = {
    get: function (target, key, receiver) {
        console.log('handler 4 get ', key)
        return Reflect.get(target, key, receiver)
    },
    set: function (target, key, val, receiver) {
        console.log('handler 4 set ', key, val)
        return Reflect.set(target, key, val, receiver)
    }
}
const handler5 = {
  get: function (target, key, receiver) {
    console.log('handler 5 get ',  key)
    return Reflect.get(target, key, receiver)
  },
  set: function (target, key, val, receiver) {
    console.log('handler 5 set ', key, val)
    return Reflect.set(target, key, val, receiver)
  }
}
...
let proxy5 = new Proxy(obj3, handler5)
let { proxyObj, d } = proxy5
// console.log(proxyObj, d)
proxyObj = 20
console.log(proxy5.proxyObj.a)
